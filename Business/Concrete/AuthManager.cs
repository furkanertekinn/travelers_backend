...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> Login(UserForLoginDto userForLoginDto)
        {
            ...
            if (userToCheck == null)
            {
                return new ErrorDateResult<User>(Messages.UserNotFound);
            }
            ...
            {
                return new ErrorDateResult<User>(Messages.PasswordError);
            }
        ...
        public IDataResult<User> Register(UserForRegisterDto userForRegisterDto, string password)
        {
            ...
            HashingHelper.CreatePasswordHah(password, out passwordHash, out passwordSalt);
            var user = new User
            {
